...
export declare type ResultOptions = {
...
export declare type ResultStreamOptions = {
    reconnects?: number;
};
/**
 ...
 */
export declare type ResultListCallback<T> = (result: T[]) => Promise<any> | any;
/**
 ...
 * @return A Promise, result or undefined
 */
export declare type SingleResultCallback<T> = (entity: T | null) => Promise<any> | any;
/**
 ...
 * @return A Promise, result or undefined
 */
export declare type CountCallback = (count: number) => Promise<any> | any;
/**
 ...
 * @return A Promise, result or undefined
 */
export declare type FailCallback = (error: PersistentError) => Promise<any> | any;
/**
 ...
 */
export declare type NextEventCallback<T extends Entity> = (event: RealtimeEvent<T>) => Promise<any> | any;
/**
