...
export declare type MatchType = 'match' | 'add' | 'change' | 'changeIndex' | 'remove';
export declare type Operation = 'insert' | 'update' | 'delete' | 'none';
/**
 * An event for a real-time query.
 */
export declare type RealtimeEvent<T extends Entity> = {
    /**
